...
touch $MyDir$WorkDir/OutputLogFile$Version.txt
...
mkdir $MyDir$WorkDir/MONTHLIES/HOMOG/STAT_PLOTS/IDADJCOMP  
mkdir $MyDir$WorkDir/MONTHLIES/HOMOG/STAT_PLOTS/PHAADJCOMP  
mkdir $MyDir$WorkDir/MONTHLIES/HOMOG/STAT_PLOTS/UNCPLOTS

mkdir $MyDir$WorkDir/MONTHLIES/HOMOG/STAT_PLOTS/IDADJCOMP/EDIR  
mkdir $MyDir$WorkDir/MONTHLIES/HOMOG/STAT_PLOTS/IDADJCOMP/QDIR  
mkdir $MyDir$WorkDir/MONTHLIES/HOMOG/STAT_PLOTS/IDADJCOMP/RHDIR  
mkdir $MyDir$WorkDir/MONTHLIES/HOMOG/STAT_PLOTS/IDADJCOMP/TDDIR  
mkdir $MyDir$WorkDir/MONTHLIES/HOMOG/STAT_PLOTS/IDADJCOMP/TDIR  
mkdir $MyDir$WorkDir/MONTHLIES/HOMOG/STAT_PLOTS/IDADJCOMP/TWDIR
...
if [ $moo -ge 29 ]; then
    ...
    echo "ISD_Initial_Station_Count="$ISDStats >> $MyDir$WorkDir/OutputLogFile$Version.txt
