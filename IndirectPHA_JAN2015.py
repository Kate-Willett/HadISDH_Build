...
TBREAKFIL   = workingdir+'/LISTS_DOCS/HadISDH.landT.'+version+'_PHA_'+nowmon+nowyear+'.log'
DPDBREAKFIL = workingdir+'/LISTS_DOCS/HadISDH.landDPD.'+version+'_PHA_'+nowmon+nowyear+'.log'
