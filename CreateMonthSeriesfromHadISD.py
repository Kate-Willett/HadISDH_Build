...
#	PHA folder: /data/local/hadkw/HADCRUH2/UPDATE2017/PROGS/PHA2015/
# 	/data/local/hadkw/HADCRUH2/UPDATE2017/MONTHLIES/NETCDF/
# 	/data/local/hadkw/HADCRUH2/UPDATE2017/MONTHLIES/ASCII/
#
# Outputs list files to:
# 	/data/local/hadkw/HADCRUH2/UPDATE2017/LISTS_DOCS/
#
...
# ipython
# %pdb
# %run CreateMonthSeriesfromHadISD.py
#
# REQUIRES
# CalcHums.py
# MakeMonths.py
...
OUTKEEP     = workingdir+'/LISTS_DOCS/goodforHadISDH.'+version+'_'+nowmon+nowyear+'.txt'
